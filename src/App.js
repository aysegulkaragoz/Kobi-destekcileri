  ...
  return (
    <HelmetProvider>
      ...
      >
        ...
        <TopNavbar />
        {location.pathname.startsWith("/akademi") ? (
          <AcademyNavbar />
        ) : (
          <Navbar />
        )}
        ...
        <a
          aria-label="whatsapp"
          href="http://wa.me/+905327614582"
          target="_blank"
          className="absolute bottom-40 right-20 animate-bounce z-10"
        >
          <svg
        ...
        <a
          ...
          href="/gorusme-ayarla"
          className="absolute bottom-20 right-10 px-8 py-2 z-10 rounded-full text-white"
